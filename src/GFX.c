...
static unsigned char cPalette[5][64][3] = {
	...
	{	/* PAL (hardcoded) */
		...
		{0xC4,0xC4,0xC4},{0x00,0x40,0xFF},{0x22,0x0E,0xDC},{0x6B,0x47,0xFF},{0x9F,0x00,0xD7},{0xD7,0x0A,0x68},{0xC8,0x00,0x00},{0xB1,0x54,0x00},
		{0x5B,0x6A,0x00},{0x03,0x8C,0x00},{0x00,0x99,0x00},{0x00,0xA2,0x2C},{0x00,0x72,0xA4},{0x2B,0x2B,0x2B},{0x00,0x00,0x00},{0x00,0x00,0x00},
		...
		{0xF8,0xED,0x88},{0xDD,0xFF,0x83},{0xB8,0xF8,0xB8},{0xD7,0xF8,0xF5},{0xC5,0xFF,0xFF},{0xD8,0xD8,0xD8},{0x00,0x00,0x00},{0x00,0x00,0x00}
	},
	{	/* RGB (hardcoded) */
